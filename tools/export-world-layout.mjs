...
import {heightAt,pathDistance,regionAt,WORLD_VERSION} from '../packages/game/src/world/regions.mjs';
...
await writeFile(resolve(directory,'world.json'),JSON.stringify({version:WORLD_VERSION,minX:-240,minZ:-480,spacing:2,heights,cells}));
