...
await writeFile(resolve(directory,'world.json'),JSON.stringify({version:WORLD_VERSION,minX:-240,minZ:-480,spacing:2,heights,cells,regions:REGIONS,routes,caves:CAVES}));
