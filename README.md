...
An original dark fantasy action RPG built on **Meep 3.26.0**, with a shared persistent world and a reproducible Blender content pipeline. The game is under active development; the current playable world still needs substantial content and art work before release.
