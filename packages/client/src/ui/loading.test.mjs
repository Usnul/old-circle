...
function fixture(){
  ...
  const element={hidden:true,animate:vi.fn(()=>animation)},postRender=new Signal();
  const engine={renderingEnabled:false,graphics:{on:{postRender,contextLost:new Signal(),contextFailed:new Signal()}}};
  return {loading:new LoadingScreen(element),engine,element,postRender,animation,complete};
}
