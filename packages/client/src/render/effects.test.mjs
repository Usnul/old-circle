...
test.each([['embers',1.9],['motes',6],['frost',1],['shockwave',1],...Object.entries(AMBIENT_EFFECTS).map(([kind,p])=>[kind,p.life]),...Object.keys(FOOTSTEP_EFFECTS).map(kind=>[kind,.6])])('%s fades light to zero before its GPU lifetime ends',(kind,life)=>{
