...
export class WorldAudio {
  constructor(engine,layout){this.engine=engine;this.layout=layout;this.events={};this.bellTime=0;this.footVoices=[];this.variants=new Map();this.voices=new Set();this.fires=new Map();this.ambientTime=1;}
  async start(){
