...
export const DUNGEONS=[{
  ...
  rooms:[
    ...
    {id:'cloister-court',name:'The Bellkeeper’s Garth',rect:[-14,14,-6,30],level:0,roof:false},
  ...
  connections:[
    ...
    ['burial','cloister-court',[-10,14,0]],['cloister-court','chapter',[-6,18,0]],
  ...
  rooms:[
    ...
    {id:'chapel',name:'Chapel of Fallen Leaves',rect:[-14,10,-4,26],level:0,roof:true},
    {id:'garden',name:'The Cloister Garden',rect:[-4,10,10,26],level:0,roof:false},
  ...
  connections:[['entry','court',[0,0,0]],['court','chapel',[-9,10,0]],['court','garden',[3,10,0]],['garden','chapel',[-4,18,0]],['court','ascent',[12,10,0]],['ascent','gallery',[12,26,4.8]],['gallery','loft',[-9,26,4.8]],['loft','return',[-6,14,4.8]]],
  ...
  rooms:[
    ...
    {id:'forebay',name:'The Silt Forebay',rect:[-6,6,10,10],level:-4.8,roof:false},
  ...
  connections:[['entry','court',[0,0,0]],['court','west',[-8,6,0]],['court','east',[12,6,0]],['west','channel',[-8,22,-4.8]],['east','channel',[12,22,-4.8]],['channel','vault',[2,22,-4.8]],['vault','forebay',[2,10,-4.8]]],
  ...
  rooms:[
    ...
    {id:'undercroft',name:'The Chart Vault',rect:[-8,8,8,24],level:0,roof:true},
  ...
  connections:[['entry','court',[0,0,0]],['court','undercroft',[0,8,0]],['court','first-stair',[-10,8,0]],['first-stair','gallery',[-10,24,4.8]],['gallery','library',[0,24,4.8]],['library','balcony',[0,8,4.8]],['balcony','second-stair',[10,8,4.8]],['second-stair','observatory',[10,24,9.6]],['observatory','return',[-2,24,9.6]]],
  ...
  rooms:[
    ...
    {id:'memorial-court',name:'The Snowbound Garth',rect:[-2,8,14,20],level:0,roof:false},
    {id:'memorial-walk',name:'The Quiet Procession',rect:[-2,20,6,28],level:0,roof:false},
  ...
  connections:[['entry','hall',[0,0,0]],['hall','memorial-court',[6,8,0]],['memorial-court','memorial-walk',[2,20,0]],['hall','ascent',[-4,8,0]],['ascent','bridge',[-4,28,4.8]],['bridge','chapel',[6,30,4.8]],['chapel','return',[16,20,4.8]]],
  ...
  rooms:[
    ...
    {id:'archive',name:'The Ledger of Kings',rect:[-8,10,8,30],level:0,roof:true},
